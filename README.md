<h1 style="text-align: center;">Introducción a la programación en Java</h1> 

Libro de introducción a la programacion en java para la facultad de ingenieria de la univeridad ECCI !
...
public class codigos {
    public static void main(String arg[]) {
        ...
        System.out.println("Hola " + name + ", ¡bienvenido al curso de java para principiantes!");
    }
}
```
...
public class codigos {
	...
	int sum_result = x + y;
	pw.println("los numeros ingresados son: " + x + ", " + y + " y la suma de ambos es: " + sum_result);
	pw.close();
	sc.close();
    }
}
...
public class codigos {
	...
	pw.println("La suma de los dos numero leidos con BufferedReader es: " + sum_result + " y la multipliacion es: " + multiplication_result);
    }
}
```
Clase Console
